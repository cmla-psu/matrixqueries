...
def configuration():
    ...
    parser.add_argument('--theta', default=1e-3,
                        help='determine when to stop conjugate gradient method'
                        ' smaller theta makes the step direction more accurate'
                        ' but it takes more time')
    parser.add_argument('--beta', default=0.5, help='step size decreament')
    parser.add_argument('--sigma', default=1e-4,
                        help='determine how much decreament in '
                        'objective function is sufficient')
    parser.add_argument('--NTTOL', default=1e-2,
    ...
    parser.add_argument('--TOL', default=1e-2,
                        help='determine when to stop the whole programe')
    parser.add_argument('--MU', default=50, help='increament for '
